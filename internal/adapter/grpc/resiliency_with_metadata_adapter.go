...
func (a *GrpcAdapter) ServerStreamingResiliencyWithMetadata(req *resl.ResiliencyRequest, stream grpc.ServerStreamingServer[resl.ResiliencyResponse]) error {
...
func (a *GrpcAdapter) ClientStreamingResiliencyWithMetadata(stream grpc.ClientStreamingServer[resl.ResiliencyRequest, resl.ResiliencyResponse]) error {
...
func (a *GrpcAdapter) BiDirectionalResiliencyWithMetadata(stream grpc.BidiStreamingServer[resl.ResiliencyRequest, resl.ResiliencyResponse]) error {
